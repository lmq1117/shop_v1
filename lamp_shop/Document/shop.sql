...
CREATE TABLE `shop_comment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `oid` int(10) unsigned DEFAULT NULL COMMENT '可以评论是因为在哪个订单买过商品',
  `cid` int(10) unsigned DEFAULT NULL COMMENT '买过哪个商品',
...
CREATE TABLE `shop_commentanswer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pid` int(10) unsigned DEFAULT NULL COMMENT '回复哪条商品评论',
  `words` varchar(255) NOT NULL COMMENT '回复的话',
  `uid` int(10) unsigned NOT NULL COMMENT '谁回复的',
  PRIMARY KEY (`id`)
...
INSERT INTO `shop_commentanswer` VALUES (1,1,'我穿不大啊',35),(2,1,'大家好，我是李双江',36),(3,2,'刚才小儿子在这里瞎说，大家不要相信',36),(4,3,'这样啊，华山用的也是这款，上次取福建避难，信号弱得不行，唉...害得我都不能跟平之聊微信了',35),(5,3,'对了，风太师叔，说说你年轻时候的故事呗',35),(6,1,'大家好，我是王大锤',33),(7,1,'小伙子们，多读书，少吹牛',34);
...
CREATE TABLE `shop_flinks` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '是否启用改友情链接',
  PRIMARY KEY (`id`)
...
INSERT INTO `shop_liuyan` VALUES (2,'唐小黄','姻缘','一如既往的好，佛祖说，求得此绳，姻缘便来，果真',1461148541),(3,'于xxx','不错1','这线充电太快了，而且耐狗咬……',1461148582),(4,'蜀黍酱','喜新厌旧','对于喜新厌旧的1人我要说句话：请继续下去~我是新来的客服蜀黍酱，喜欢请叩1，超爱请叩2，么么哒请叩3~感谢您对小米的支持^ ^',1461148779);
...
CREATE TABLE `shop_orders` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0:新订单1:已发货2:已收货3:无效订单4:因为添加订单地址程序自动创建的订单',
  PRIMARY KEY (`id`)
...
INSERT INTO `shop_users` VALUES (1,'admin','e10adc3949ba59abbe56e057f20f883e','1','13888888888','8888@qq.com','default.jpg',0,1,1460356697),(16,'小仓娃','e10adc3949ba59abbe56e057f20f883e','1','13199899899','xiaocangwa@dengfeng.com','a85257aa680631febf804a3b1c38f21d.jpg',3,1,1460826947),(17,'严守一','e10adc3949ba59abbe56e057f20f883e','1','111111','yanshouyi@shouji.com','2be65491b936bf6291c1686e6118fbfa.jpeg',2,1,1460533654),(18,'4444','e10adc3949ba59abbe56e057f20f883e','2','444','4444','5d2be9a570660c84afdf83053590adfc.jpeg',3,1,1460465558),(19,'abc$','e10adc3949ba59abbe56e057f20f883e','0','1599999999','sam@123.com','56933c23b7f74623cd6a22d4776546a1.jpg',2,0,1460826507),(20,'abc^','e10adc3949ba59abbe56e057f20f883e','0','13526532135','sam@123.com','d51a9fecf0f8dc5cf10fdba6afc929e3.jpeg',2,1,1460464024),(21,'sfsdfds','e10adc3949ba59abbe56e057f20f883e','0','sfdsfd','sdf','default.jpg',2,1,1460465381),(22,'1111111','e10adc3949ba59abbe56e057f20f883e','1','','','ded12bc30f8973b9bdfd8d81966ba22b.jpg',2,1,1460640131),(23,'王小二','e10adc3949ba59abbe56e057f20f883e','1','13526532135','111@111.com','default.jpg',3,1,1460507382),(24,'SAFDSF','e10adc3949ba59abbe56e057f20f883e','0','','','default.jpg',3,0,1460465792),(25,'赛西施','e10adc3949ba59abbe56e057f20f883e','0','','','default.jpg',3,0,1460465911),(26,'ushuda','e10adc3949ba59abbe56e057f20f883e','0','asdkfa','afajkfa','17f5d31876e58f611a95b64f5a2eb58b.jpeg',3,1,1460469942),(27,'sam_pt1','e10adc3949ba59abbe56e057f20f883e','0','123','SFD','default.jpg',3,0,1460471036),(28,'E阿7d','e10adc3949ba59abbe56e057f20f883e','0','','','default.jpg',3,0,1460527089),(29,'王小五','e10adc3949ba59abbe56e057f20f883e','0','13526532135','sam@123.com','979131a676a80057394b53877bcc2eb1.jpg',3,1,1460826407),(30,'id30id','e10adc3949ba59abbe56e057f20f883e','0','13526532135','sam@123.com','3b7d7db5ba17964e4464400ab847bb49.jpg',3,1,1460826891),(31,'admin2','e10adc3949ba59abbe56e057f20f883e','2',NULL,NULL,'default.jpg',3,1,1460991455),(32,'要啥自行车啊','e10adc3949ba59abbe56e057f20f883e','2',NULL,NULL,'default.jpg',3,1,1460991530),(33,'王大锤','e10adc3949ba59abbe56e057f20f883e','2',NULL,NULL,'default.jpg',3,1,1461032792),(34,'风清扬','a03e39c68fe243014ab66bda8473cb72','2','','','e26b9ab0929cc1bf25ee20099a705e79.jpg',3,1,1461203179),(35,'岳灵珊','9ae07b2ba6e8a47a5cb4448142e7195e','2','','','a299400163106b311cc2ce01107ce9a1.jpg',3,1,1461203159),(36,'银枪小霸王','e10adc3949ba59abbe56e057f20f883e','2',NULL,NULL,'default.jpg',3,1,1461156744);
...
-- Dump completed on 2016-04-21 11:21:06
