          ...
          <div class="mainbox" id="login-main">
            ...
            <div>
              <div class="login_area">
              	<!-- 表单开始 -->
                <form action="./action.php?handler=login" id="login-main-form" method="post">
                  <div class="loginbox c_b">
                    ...
                    <div class="lgn_inputbg c_b">
                      ...
                      <label id="region-code" class="labelbox login_user c_b" for="">
                        ...
                        <!-- 用户名 -->
                        <input class="item_account" autocomplete="off" name="user" id="username" placeholder="请输入用户名" type="text">
                      </label>
                      ...
                      <label class="labelbox pwd_panel c_b">
                        ...
                        <!-- 密码 -->
                        <input placeholder="密码" name="pwd" id="pwd" type="password">
                      </label>
                    </div>


					<div class="inputbg inputcode dis_box">
		          		<label style="" class="labelbox" for="" style="margin-left:-78px;"><input class="code" name="yzm" autocomplete="off" placeholder="图片验证码" type="text"></label>
		          		<img style="margin-bottom: -13px;margin-left: 5px;" src="../Common/yzm.php" alt="图片验证码" class="icode_image code-image" title="看不清换一张" onclick="this.src='../Common/yzm.php?rand='+Math.random()" />
		       		</div>
                    ...
                    <div class="btns_bg">
                      ...
                      <span style="display: none;" id="custom_display_8" class="sns-default-container sns_default_container">
                      </span>
                    </div>
                  </div>
                </form>
            ...
            <div class="n_links_area" id="custom_display_64">
              <a class="outer-link" href="./register.php">注册小米帐号</a><span>|</span>
          ...
          <div class="ercode_area" id="login-qrcode">
            ...
            <div class="ercode_box">
              ...
              <div class="code_iframe">
                <iframe style="background:#fff;" src="../Common/Public/login/a.htm" id="qriframe" scrolling="no" frameborder="0"></iframe>
              </div>
            </div>
          </div>
