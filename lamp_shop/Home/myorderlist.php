                                ...
                                <ul class="order-list">
                                    ...
                                    <?php 
                                        ...
                                        if($selectDb)
                                        {
                                            ...
                                            {
                                                //准备sql语句
                                                $sql = "select * from`" . PIX . "orders` where `uid` = {$_SESSION['userInfo']['id']} and `status` <> 4 order by `addtime` desc";
                                                                ...
                                                                <td class="order-items"> 
                                                                    <ul class="goods-list">  
                                                                        ...
                                                                        <?php if(count($commoditylist) > 0):?>
                                                                            ...
                                                                            <li> <div class="figure figure-thumb">   <a href="./detail.php?id=<?= $v['cid']?>" target="_blank"> <img src="../Common/Public/images/commodity/<?= $v['picture']?>" alt="<?= $v['name']?>" height="80" width="80"> </a>   </div> <p class="name"> <a data-stat-id="d973c7f891a6b326" href="./detail.php?id=<?= $v['cid']?>" target="_blank"><?= $v['name']?></a>  </p> <p class="price"><?= $v['price']?>元 × <?= $v['num']?></p> </li>
                                                                            <?php endforeach;?>        
                                                                        <?php else:?>
                                                                            <h2>订单数据异常！</h2>  
                                                                        <?php endif;?>  
